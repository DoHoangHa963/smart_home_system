...
public class RoomController {
    ...
    public ResponseEntity<ApiResponse<List<RoomResponse>>> getRoomsByHomeId(
            @PathVariable("homeId") Long homeId
    ) {
        log.debug("Getting rooms for home: {}", homeId);
        List<RoomResponse> rooms = roomService.getRoomsByHomeId(homeId);
